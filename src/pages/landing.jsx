      ...
      <nav className="sticky top-0 z-50 bg-[#FEFEFE] text-[#666666] px-4 py-4 shadow">
        <div className="flex flex-wrap items-center justify-between max-w-[1440px] mx-auto w-full">
          <div className="flex items-center gap-6 flex-1 flex-wrap">
            ...
            <div className="hidden md:flex gap-6 font-medium">
              ...
              <Link to="/contract" className="hover:underline">Contract Manufacturing</Link>
              <Link to="/private" className="hover:underline">Private Labelling</Link>
              <Link to="/corporate" className="hover:underline">Corporate Gifting</Link>
            </div>
        ...
        {menuOpen && (
          <div className="md:hidden flex flex-col gap-4 mt-4 text-sm font-medium px-4">
            ...
            <Link to="/contract" onClick={() => setMenuOpen(false)} className="hover:underline">Contract Manufacturing</Link>
            <Link to="/private" onClick={() => setMenuOpen(false)} className="hover:underline">Private Labelling</Link>
            <Link to="/corporate" onClick={() => setMenuOpen(false)} className="hover:underline">Corporate Gifting</Link>
            <button onClick={() => setMenuOpen(false)} className="hover:underline text-left">Sign-In</button>
          </div>
        )}
      </nav>
              ...
              <div className="bg-gradient-to-b from-light to-olive rounded-b-3xl">
                <div className="max-w-[1440px] mx-auto flex flex-col md:flex-row justify-between px-4 sm:px-8 md:px-16 xl:px-24 2xl:px-32 pt-20 h-auto md:h-[350px]">
                  <div className="flex-1 flex flex-col justify-start text-center md:text-left space-y-2">
                    <p className="text-[#3D3D3D] font-light pb-[24px]">
                    ...
                    <div className="flex justify-center md:justify-start gap-4 mt-4">
                      ...
                      <Link to="/#products">
                        <button className="bg-white text-[#6F8675] px-4 py-2 rounded-[12px] font-semibold">
                          View Products
                        </button>
                      </Link>
                    </div>
